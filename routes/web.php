...
use App\Http\Controllers\ModuleHomeController;
...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::get('/apps', ModuleHomeController::class)->name('modules.home');
    Route::get('/dashboard', DashboardController::class)->name('dashboard');
    Route::get('/my-checkin', function (\Illuminate\Http\Request $request) {
        $staff = $request->user()?->staff;
        abort_unless($staff !== null && filled($staff->checkin_token), 404);

        return redirect()->to($staff->checkinUrl());
    })->name('staff-checkin.mine');
    ...
    Route::middleware('permission:students.manage')->group(function () {
        ...
        Route::get('/classes/{schoolClass}/roster/bulk-template', [ClassController::class, 'downloadStudentBulkTemplate'])
            ->whereNumber('schoolClass')
            ->name('classes.roster.bulk-template');
        Route::post('/classes/{schoolClass}/roster/bulk-upload', [ClassController::class, 'bulkUploadStudents'])
            ->whereNumber('schoolClass')
            ->name('classes.roster.bulk-upload');
    });
    ...
    Route::middleware('permission:staff.view')->group(function () {
        ...
        Route::get('/staff-attendance/history/print', [StaffAttendanceController::class, 'printHistory'])->name('staff-attendance.history.print');
    });

    Route::middleware('permission:staff.manage')->group(function () {
        Route::post('/staff', [StaffController::class, 'store'])->name('staff.store');
        Route::put('/staff/{staff}', [StaffController::class, 'update'])->whereNumber('staff')->name('staff.update');
        Route::put('/staff/{staff}/classes', [StaffController::class, 'updateClasses'])->whereNumber('staff')->name('staff.classes.update');
        ...
        Route::post('/staff/{staff}/reset-login-password', [StaffController::class, 'resetLoginPassword'])->whereNumber('staff')->name('staff.reset-login-password');
        Route::get('/staff-attendance', [StaffAttendanceController::class, 'index'])->name('staff-attendance.index');
        Route::get('/staff-attendance/print', [StaffAttendanceController::class, 'print'])->name('staff-attendance.print');
    ...
    Route::middleware('permission:settings.manage')->group(function () {
        ...
        Route::post('/settings/weekly-periods', [SettingsController::class, 'updateWeeklyPeriods'])->name('settings.weekly-periods');
        Route::post('/settings/day-structure', [SettingsController::class, 'updateDayStructure'])->name('settings.day-structure');
        ...
        Route::post('/settings/grade-boundaries', [SettingsController::class, 'updateGradeBoundaries'])->name('settings.grade-boundaries');
        Route::post('/settings/term-marks', [SettingsController::class, 'updateTermMarks'])->name('settings.term-marks');
        Route::redirect('/grades/boundaries', '/settings?tab=grades')->name('grades.boundaries');
        Route::post('/grades/boundaries', [SettingsController::class, 'updateGradeBoundaries'])->name('grades.boundaries.update');
    });
    ...
    Route::middleware('permission:reports.academic')->group(function () {
        Route::get('/reports/attendance', [ReportController::class, 'attendance'])->name('reports.attendance');
        Route::get('/reports/attendance/print', [ReportController::class, 'attendance'])->name('reports.attendance.print');
        Route::get('/reports/academic', [ReportController::class, 'academic'])->name('reports.academic');
        Route::get('/reports/academic/print', [ReportController::class, 'academic'])->name('reports.academic.print');
        Route::get('/reports/enrollment', [ReportController::class, 'enrollment'])->name('reports.enrollment');
        Route::get('/reports/enrollment/print', [ReportController::class, 'enrollment'])->name('reports.enrollment.print');
    });
    ...
    Route::middleware('permission:classes.view')->group(function () {
        ...
        Route::get('/classes/{schoolClass}/roster/print', [ClassController::class, 'printRoster'])->whereNumber('schoolClass')->name('classes.roster.print');
    ...
    Route::middleware('permission:timetable.view')->group(function () {
        ...
        Route::get('/timetable/requirements', [TimetableController::class, 'requirements'])->name('timetable.requirements');
        Route::get('/timetable/print', [TimetableController::class, 'print'])->name('timetable.print');
    });

    Route::middleware('permission:attendance.view')->group(function () {
        Route::get('/attendance', [AttendanceController::class, 'index'])->name('attendance.index');
        Route::get('/attendance/week-sheet', [AttendanceController::class, 'weekSheet'])->name('attendance.week-sheet');
    ...
    Route::middleware('permission:grades.view')->group(function () {
        ...
        Route::get('/grades/sheet/print', [GradeController::class, 'printSheet'])->name('grades.sheet.print');
    ...
    Route::middleware('permission:fees.view')->group(function () {
        ...
        Route::get('/finance/fee-collection/print', [FinanceController::class, 'printCollection'])->name('finance.fee-collection.print');
    ...
    Route::middleware('permission:fees.generate')->group(function () {
    ...
    Route::middleware('permission:expenses.view')->group(function () {
        ...
        Route::get('/finance/expenses/print', [ExpenseController::class, 'print'])->name('finance.expenses.print');
    });
    ...
    Route::middleware('permission:expenses.manage')->group(function () {
        ...
        Route::post('/finance/expense-categories', [ExpenseController::class, 'storeCategory'])->name('finance.expense-categories.store');
    });
    ...
    Route::middleware('permission:payroll.view')->group(function () {
        ...
        Route::get('/payroll/{payrollRun}/print', [PayrollController::class, 'printRun'])->whereNumber('payrollRun')->name('payroll.print');
        Route::get('/payroll/{payrollRun}/payslips/{payrollItem}', [PayrollController::class, 'payslip'])
            ->whereNumber(['payrollRun', 'payrollItem'])
            ->name('payroll.payslip');
    });

    Route::middleware('permission:payroll.run')->group(function () {
